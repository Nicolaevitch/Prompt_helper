...
DOCS_FILE = PROJECT_ROOT / "rag/documents.json"
EMB_FILE = PROJECT_ROOT / "rag/embeddings/embeddings.json"
...
def expand_with_graph(seed_block_ids, matched_file_paths, intent):
    ...
    if targeted_file_mode:
        ...
        for path in matched_file_paths:
            ...
            targeted_block_ids.update(
                file_to_block_ids.get(path.lower(), set())
            )
